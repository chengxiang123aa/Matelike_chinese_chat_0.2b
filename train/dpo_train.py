...
from transformers import PreTrainedTokenizerFast, TrainingArguments      #PreTrainedTokenizerFast 来自 Hugging Face 的 transformers 库,于快速加载预训练的 tokenizer（词表化工具），比如 BERT、T5 等预训练模型的分词器
